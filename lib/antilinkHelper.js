...
// Direct data path selection matching userGroupData structure configuration mapping parameters
...
function loadAntilinkSettings() {
    ...
    try {
        ...
        console.error('❌ Error loading antilink settings data file:', error.message);
        return {};
    }
}
...
function saveAntilinkSettings(settings) {
    try {
        ...
        console.error('❌ Error writing antilink settings data storage:', error.message);
    }
}
