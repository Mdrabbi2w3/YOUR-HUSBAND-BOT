    ...
    try {
        ...
        if (!args[0]) {
            await sock.sendMessage(chatId, { 
                text: '⚠️ *YOUR HUSBAND* ⚠️\n\nPlease enter the Telegram sticker URL!\n\n*Example:* !tg https://t.me/addstickers/Porcientoreal' 
            }, { quoted: msg });
            return;
        }
        ...
        if (!args[0].match(/(https:\/\/t.me\/addstickers\/)/gi)) {
            await sock.sendMessage(chatId, { 
                text: '❌ *YOUR HUSBAND* ❌\n\nInvalid URL! Make sure it\'s a valid Telegram sticker URL.' 
            }, { quoted: msg });
            return;
        }
        ...
        try {
            ...
            await sock.sendMessage(chatId, { 
                text: `📦 *YOUR HUSBAND STICKER DOWNLOADER* 📦\n\nFound ${stickerSet.result.stickers.length} stickers.\n⏳ Starting download... Please wait.` 
            }, { quoted: msg });
            ...
            for (let i = 0; i < stickerSet.result.stickers.length; i++) {
                try {
                    ...
                    // Create metadata branded for YOUR HUSBAND
                    const metadata = {
                        'sticker-pack-id': crypto.randomBytes(32).toString('hex'),
                        'sticker-pack-name': 'YOUR HUSBAND',
            ...
            await sock.sendMessage(chatId, { 
                text: `✅ *YOUR HUSBAND* \n\nSuccessfully downloaded ${successCount}/${stickerSet.result.stickers.length} stickers!` 
            }, { quoted: msg });
