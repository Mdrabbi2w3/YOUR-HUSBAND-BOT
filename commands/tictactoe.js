    ...
    try {
        ...
        if (Object.values(games).find(room => 
            ...
            await sock.sendMessage(chatId, { 
                text: '❌ *YOUR HUSBAND* ❌\n\nYou are still in an active game. Type *surrender* to quit before starting a new one.' 
            });
            return;
        }
...
`;
            ...
            await sock.sendMessage(chatId, { 
                text: `⏳ *YOUR HUSBAND GAME ROOM* ⏳\n\nWaiting for an opponent to join...\nType *!ttt ${text || ''}* to join the battle!`
            });
...
async function handleTicTacToeMove(sock, chatId, senderId, text) {
    try {
        ...
        if (senderId !== room.game.currentTurn && !isSurrender) {
            await sock.sendMessage(chatId, { 
                text: '❌ Not your turn! Please wait for your opponent.' 
            });
            return;
        }
        ...
        if (isSurrender) {
            ...
            await sock.sendMessage(chatId, { 
                text: `🏳️ @${senderId.split('@')[0]} has surrendered!\n🎉 @${winner.split('@')[0]} wins the game!`,
