...
async function handleTranslateCommand(sock, chatId, message, match) {
    try {
        ...
        if (!textToTranslate) {
            return sock.sendMessage(chatId, {
                text: '❌ *YOUR HUSBAND* ❌\n\nNo text found to translate. Please provide text or reply to a message.',
                quoted: message
            });
        }
        ...
        // Send translation branded for YOUR HUSBAND
        await sock.sendMessage(chatId, {
            text: `🌐 *YOUR HUSBAND TRANSLATION* 🌐\n\n${translatedText}`,
        }, {
            quoted: message
        });
