        ...
        try {
                        ...
                        for (let i = 0; i < Math.min(20, mediaData.length); i++) {
                            ...
                            if (isVideo) {
                                await sock.sendMessage(chatId, {
                                    video: { url: mediaUrl },
                                    mimetype: "video/mp4",
                                    caption: "✨ *DOWNLOADED BY YOUR HUSBAND* ✨"
                                }, { quoted: message });
                            } else {
                                await sock.sendMessage(chatId, {
                                    image: { url: mediaUrl },
            ...
            if (videoUrl) {
                try {
                    ...
                    const caption = title ? `✨ *DOWNLOADED BY YOUR HUSBAND* ✨\n\n📝 *Title:* ${title}` : "✨ *DOWNLOADED BY YOUR HUSBAND* ✨";
            ...
            return await sock.sendMessage(chatId, { 
                text: "❌ *YOUR HUSBAND* ❌\n\nFailed to download TikTok video. All download methods failed. Please try again with a different link."
            },{ quoted: message });
        } catch (error) {
