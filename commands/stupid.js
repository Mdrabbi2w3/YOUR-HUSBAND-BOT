...
async function stupidCommand(sock, chatId, quotedMsg, mentionedJid, sender, args) {
    try {
        ...
        // Send the image with caption branded for YOUR HUSBAND
        await sock.sendMessage(chatId, {
            image: imageBuffer,
            caption: `✨ *YOUR HUSBAND MEME GENERATOR* ✨\n\n💬 *@${who.split('@')[0]}*`,
            mentions: [who]
        });
        ...
        await sock.sendMessage(chatId, { 
            text: '❌ *YOUR HUSBAND* ❌\n\nSorry, I couldn\'t generate the meme template. Please try again later!'
        });
    }
}
